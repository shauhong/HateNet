...
const Login = () => {
    ...
    const { login } = useAuth();
    const { login: handleLogin, openToast } = useGlobal();
    ...
    return (
        <div className="flex-1 flex items-center justify-center">
            <div className="flex-1 max-w-md my-6">
                <div className='mb-6'>
                    <p className="font-bold text-center text-5xl">Welcome back</p>
                </div>
                <div className="mx-8">
                    <form>
                        <div>
                        ...
                        <div className="mt-2">
                            <button className="flex justify-center items-center gap-x-4 bg-sky-500 text-white font-medium rounded-3xl px-4 py-2 hover:bg-sky-600 cursor-pointer w-full">
                        ...
                        <div className="mt-4 font-medium">
                            <span>Don't have an account? <Link to="/register"><span className="text-sky-500 hover:text-sky-600">Register</span></Link></span>
                        </div>
                    </form>
                </div>
            </div>
